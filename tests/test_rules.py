...
class TestRules(unittest.TestCase):
    ...
    def test_legal_trademark_violations(self):
        # See Issue # https://github.com/khulnasoft-lab/yara-repo/issues/1028
    ...
    def test_optional_tags(self):
        ...
        self.assertEqual(files_with_incorrect_tags, [], Fore.RED +
                         "There are rules with incorrect/unknown Tags. (please inform us about new tags that are not yet supported in our tests) and check the correct tags here: https://github.com/khulnasoft-lab/yara-repo-specification/blob/main/Tags_specification.md ")
    ...
    def test_optional_related(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules with malformed optional 'related' fields. (check https://github.com/khulnasoft-lab/yara-repo-specification)")
    ...
    def test_optional_status(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules with malformed or missing 'status' fields. (check https://github.com/khulnasoft-lab/yara-repo-specification)")
    ...
    def test_level(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules with missing or malformed 'level' fields. (check https://github.com/khulnasoft-lab/yara-repo-specification)")
    ...
    def test_references_in_description(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules with malformed 'description' fields. (links and external references have to be in a seperate field named 'references'. see specification https://github.com/khulnasoft-lab/yara-repo-specification)")
    ...
    def test_file_names(self):
        ...
        for file in self.yield_next_rule_file_path(self.path_to_rules):
            ...
            if filename in name_lst:
                ...
                # Fix Issue #1381 (https://github.com/khulnasoft-lab/yara-repo/issues/1381)
    ...
    def test_title(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules with non-conform 'title' fields. Please check: https://github.com/khulnasoft-lab/yara-repo/wiki/Rule-Creation-Guide#title")
    ...
    def test_duplicate_titles(self):
        ...
        self.assertEqual(faulty_rules, [], Fore.RED +
                         "There are rules that share the same 'title'. Please check: https://github.com/khulnasoft-lab/yara-repo/wiki/Rule-Creation-Guide#title")
    ...
    #     self.assertEqual(faulty_rules, [], Fore.RED +
    #                      "There are rules with non-conform 'logsource' fields. Please check: https://github.com/khulnasoft-lab/yara-repo/wiki/Rule-Creation-Guide#log-source")
    ...
    def test_selection_start_or_and(self):
        ...
        for file in self.yield_next_rule_file_path(self.path_to_rules):
            ...
            if detection:
                ...
                # This test is a best effort to avoid breaking SIGMAC parser. You could do more testing and try to fix this once and for all by modifiying the token regular expressions https://github.com/khulnasoft-lab/yara-repo/blob/b9ae5303f12cda8eb6b5b90a32fd7f11ad65645d/tools/sigma/parser/condition.py#L107-L127
                for key in detection:
                    if key[:3].lower() == "sel":
                       continue
                    elif key[:2].lower() == "or":
