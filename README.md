[![sigma build status](https://github.com/khulnasoft-lab/yara-repo/actions/workflows/sigma-test.yml/badge.svg?branch=master)](https://github.com/khulnasoft-lab/yara-repo/actions?query=branch%3Amaster)
...
1. Sigma rule specification in the [Sigma-Specification](https://github.com/khulnasoft-lab/yara-repo-specification) repository
...
The specifications can be found in the [Sigma-Specification](https://github.com/khulnasoft-lab/yara-repo-specification) repository.
...
* The [Sigma Specification](https://github.com/khulnasoft-lab/yara-repo-specification) and the Sigma logo are public domain
